...
public class sweetbunny extends PApplet {
...
public void drawGameOver()
{
  ...
  public void settings() {  size(700, 520); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sweetbunny" };
    if (passedArgs != null) {
